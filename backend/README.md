...
## Project Structure
    ...
    ├── athensandcompany_28988  # Django project configurations
...
1. Clone this repo and `cd athensandcompany_28988`
...
2. Clone this repo and `cd athensandcompany_28988`
